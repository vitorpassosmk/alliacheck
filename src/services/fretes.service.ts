...
export type FreteComRelacoes = Tables<'fretes'> & {
  ...
  motoristas: Pick<Tables<'motoristas'>, 'nome' | 'cnh' | 'validade_cnh' | 'banco' | 'agencia_conta' | 'chave_pix' | 'cpf' | 'telefone' | 'whatsapp'> | null
  veiculos: Pick<Tables<'veiculos'>, 'placa' | 'tipo' | 'tipo_veiculo' | 'placa_carreta' | 'proprietario' | 'cpf_proprietario' | 'banco_proprietario' | 'agencia_conta_proprietario' | 'chave_pix_proprietario' | 'whatsapp_proprietario'> | null
}
